...
from .views import upload_old_works, view_old_works, download_old_works, upload_works, download_works, \
    view_work, work_home, clear_work, create_work, work_edit, work_delete, work_sort, work_reverse_sort
...
urlpatterns = [
    ...
    path('sort-work/<str:column>', work_sort, name='sort-work'),
    path('reverse-sort-work/<str:column>', work_reverse_sort, name='reverse-sort-work'),
]
